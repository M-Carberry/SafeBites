...
export default function RestProfile() {
  ...
  const restaurant = {
    id:"8",
    route: "/restuarantprof_halal",
    type: "Middle Eastern Food",
    ...
    phone: "(407) 620-2069",
    address: "12715 Pegasus Drive Orlando, FL 32816",
    hours: [
    ...
    <View style={styles.container}>
      ...
      <View style={styles.stickyBtns}>
        <Pressable 
          ...
          onPress={() => Linking.openURL('https://www.thehalalshack.com/discover-deliciousness/menu')}
        >
